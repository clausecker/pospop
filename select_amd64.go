...
func count8avx2carry(counts *[8]int, buf []byte)
func count8avx2(counts *[8]int, buf []byte)
func count8sse2carry(counts *[8]int, buf []byte)
...
var count8funcs = []count8impl{
	...
	{count8avx2carry, "avx2carry", cpu.X86.HasAVX2},
	{count8avx2, "avx2", cpu.X86.HasAVX2},
	{count8sse2carry, "sse2carry", cpu.X86.HasSSE2},
