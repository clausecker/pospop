...
func count8avx512mula(counts *[8]int, buf []byte)
...
var count8funcs = []count8impl{
	...
	{count8avx512mula, "avx512mula", cpu.X86.HasBMI2 && cpu.X86.HasAVX512BW},
...
var count16funcs = []count16impl{
	...
	{count16avx512mula, "avx512mula", cpu.X86.HasBMI2 && cpu.X86.HasAVX512BW},
...
var count32funcs = []count32impl{
	...
	{count32avx512mula, "avx512mula", cpu.X86.HasBMI2 && cpu.X86.HasAVX512BW},
...
var count64funcs = []count64impl{
	...
	{count64avx512mula, "avx512mula", cpu.X86.HasBMI2 && cpu.X86.HasAVX512BW},
